...
import com.example.ui.FollowableTopicPreviewParameterProvider
    ...
    Column(
        ...
        when (uiState) {
            InterestsUiState.Loading ->
                NiaLoadingWheel(
                    modifier = modifier,
                    contentDesc = stringResource(id = R.string.films_interests_loading),
                )
...
private fun InterestsEmptyScreen() {
    Text(text = stringResource(id = R.string.films_interests_empty_header))
}
