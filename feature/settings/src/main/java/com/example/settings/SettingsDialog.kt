...
import com.example.model.data.DarkThemeConfig
import com.example.model.data.ThemeBrand
import com.example.model.data.ThemeBrand.ANDROID
import com.example.model.data.ThemeBrand.DEFAULT
import com.example.settings.R.string
import com.example.settings.SettingsUiState.Loading
import com.example.settings.SettingsUiState.Success
...
private fun ColumnScope.SettingsPanel(
    ...
    Column(Modifier.selectableGroup()) {
        SettingsDialogThemeChooserRow(
            ...
            selected = settings.darkThemeConfig == com.example.model.data.DarkThemeConfig.FOLLOW_SYSTEM,
            onClick = { onChangeDarkThemeConfig(com.example.model.data.DarkThemeConfig.FOLLOW_SYSTEM) },
        )
        SettingsDialogThemeChooserRow(
